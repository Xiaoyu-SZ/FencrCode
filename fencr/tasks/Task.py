...
class Task(object):
    ...
    def add_task_args(parent_parser):
        ...
        parser.add_argument('--model_name', type=str,
                            default='BiasedMF', help='Choose model to run.')
        parser.add_argument('--dataset', type=str,
                            default='ml100k-5-1', help='Choose dataset to run.')
    ...
    def _init_model(self):
        ...
        # # read data
        reader = model.read_data(
            dataset_dir=os.path.join(DATASET_DIR, self.dataset))
